...
{
    public partial class Tenant_DarelShroukContext : DbContext
    {
        public Tenant_DarelShroukContext()
        {
        }

        public Tenant_DarelShroukContext(DbContextOptions<Tenant_DarelShroukContext> options)
            : base(options)
        {
        }
